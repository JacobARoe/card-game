...
pub fn setup_event_screen(mut commands: Commands) {
    ...
    commands.spawn((
        ...
        parent.spawn(TextBundle::from_section(desc, TextStyle {
            font: Handle::default(),
            font_size: 24.0,
            color: Color::WHITE,
        }));
        ...
        for (text, id) in options {
             parent.spawn((
                ...
                b.spawn(TextBundle::from_section(text, TextStyle {
                    font: Handle::default(),
                    font_size: 20.0,
                    color: Color::WHITE,
                }));
...
pub fn event_interaction_system(
    ...
    interaction_query: Query<(&Interaction, &EventOptionButton), (Changed<Interaction>, With<EventOptionButton>)>,
) {
