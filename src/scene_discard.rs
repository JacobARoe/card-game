...
pub fn setup_view_discard_overlay(mut commands: Commands, discard: Res<DiscardPile>) {
    commands.spawn((
        NodeBundle {
            ...
            z_index: ZIndex::Global(300), // Higher than battle UI
            ..default()
        },
        ViewDiscardUI,
    )).with_children(|parent| {
        // Header
        parent.spawn(TextBundle::from_section(format!("Discard Pile ({})", discard.cards.len()), TextStyle {
            font: Handle::default(),
            font_size: 40.0,
            color: Color::WHITE,
        }));
        ...
        parent.spawn(NodeBundle {
            ...
            let mut sorted_cards = discard.cards.clone();
...
pub fn view_discard_interaction_system(
    mut next_turn_state: ResMut<NextState<TurnState>>,
    interaction_query: Query<&Interaction, (Changed<Interaction>, With<ReturnFromDiscardButton>)>,
) {
