...
pub fn setup_character_select_screen(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    commands.spawn((
        ...
        parent.spawn(TextBundle::from_section("Select Your Character", TextStyle {
            font: Handle::default(),
            font_size: 50.0,
            color: Color::WHITE,
        }));
        ...
        parent.spawn(NodeBundle {
            ...
            container.spawn((
                ...
                btn.spawn(TextBundle::from_section("The Duelist", TextStyle {
                    font: Handle::default(),
                    font_size: 30.0,
                    color: Color::WHITE,
                }));
                btn.spawn(TextBundle::from_section("A balanced warrior.", TextStyle {
                    font: Handle::default(),
                    font_size: 16.0,
            ...
            container.spawn((
                ...
                btn.spawn(TextBundle::from_section("The Spellweaver", TextStyle {
                    font: Handle::default(),
                    font_size: 30.0,
                    color: Color::WHITE,
                }));
                btn.spawn(TextBundle::from_section("Master of the arcane.", TextStyle {
                    font: Handle::default(),
                    font_size: 16.0,
                    color: Color::srgb(0.8, 0.8, 0.8),
                }).with_style(Style {
